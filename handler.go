...
// that will attempt to map any paths to their corresponding URL. If the path is not provided in the YAML, then the
// fallback http.Handler will be called instead. YAML is expected to be in the format:
//
//     - path: /some-path
